  ...
  <tr>
    ...
    <?php
                ...
                include_once 'includes/dbh.inc.php';
                            ...
                            if(!mysqli_stmt_prepare($stmt,$sql)) {
                                ...
                                while ($row=mysqli_fetch_assoc($result)) {
                                  $_SESSION['warehouse_product_id'] = $row['warehouse_product_id'];
                ...
                echo '
                   ...
                   <a href="includes/product-move.php?info='.$row["warehouse_product_id"].'"><p>Move</P></a>
                 ';

                 echo '

                 <form action="includes/product-move-to-store.php" method="post" enctype="multipart/form-data">
                 <button name="move" value="'.$row["warehouse_product_id"].'">Move</button>
                 </form>
                 '
